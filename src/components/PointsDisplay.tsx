...
export default function PointsDisplay({ className = '' }: PointsDisplayProps) {
  ...
  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      <div className="flex items-center space-x-1.5 px-3 py-1.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg shadow-md">
        <svg
        ...
        <span className="text-white font-semibold text-sm tabular-nums">
          {displayPoints.toFixed(3)} Points
        </span>
      </div>
    </div>
  );
